...
echo "  6. Observability (Tempo distributed tracing + OpenTelemetry Collector + Grafana)"
echo "    6-1. Kuadrant Observability (ServiceMonitors, PrometheusRules)"
echo "    6-2. Kuadrant Dashboards (Grafana ConfigMaps)"
echo ""
...
echo "  Grafana:  https://grafana.${EXTERNAL_BASE_DOMAIN}/"
echo ""
echo "ArgoCD Console:"
