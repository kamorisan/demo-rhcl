...
echo "  1. Operators (Service Mesh, RHCL, Kuadrant, MCP Gateway, RHBK, OpenTelemetry, Tempo)"
echo "  2. Platform CRs (ClusterIssuer, Istio, Kuadrant)"
echo "  2-2. Kuadrant Observability (Grafana Operator + monitoring namespace)"
...
echo "  5. Routes & Policies (29 HTTPRoutes + Auth/OIDC Policies)"
...
echo "  Grafana:  https://grafana-rhcl-workshop.${EXTERNAL_BASE_DOMAIN}/"
echo ""
echo "ArgoCD Console:"
